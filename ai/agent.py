...
class Agent:
    def __init__(self) -> None:
        ...
        self.memory = deque(maxlen=MAX_MEMORY) # automatically calls pop_left()
        self.model = Linear_QNet(11, 256, 3)
        if self.model.saved() != None:
            print("Model found...")
            self.model.load_state_dict(torch.load(self.model.saved()))
    ...
    def get_action(self, state):
        # random movies: tradeoff exploration / exploitation
